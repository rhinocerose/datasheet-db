SamacSys ECAD Model
282501/454976/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOT95P270X145-6N" (originalName "SOT95P270X145-6N")
		(multiLayer
			...
			(pad (padNum 5) (padStyleRef r140_60) (pt 1.25, 0) (rotation 90))
			(pad (padNum 6) (padStyleRef r140_60) (pt 1.25, 0.95) (rotation 90))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -1.95 1.6) (pt -0.55 1.6) (width 0.2))
		)
	)
	(symbolDef "MCP4726A0T-E_CH" (originalName "MCP4726A0T-E_CH")
	...
	(compDef "MCP4726A0T-E_CH" (originalName "MCP4726A0T-E_CH") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "VREF") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP4726A0T-E_CH"))
		(attachedPattern (patternNum 1) (patternName "SOT95P270X145-6N")
			(numPads 6)
			(padPinMap
		...
		(attr "Mouser Part Number" "579-MCP4726A0TECH")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/MCP4726A0T-E-CH?qs=ggQiQSXuoRUfw4Repi%252B5rQ%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "MCP4726A0T-E/CH")
		(attr "Description" "12-bit DAC, NV, 1-channel, I2C, SOT23-6 Microchip MCP4726A0T-E/CH, 12 bit Serial DAC, 6-Pin SOT-23")
		(attr "Datasheet Link" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-DGA17/911550.pdf")
		(attr "Height" "1.45 mm")
	)
