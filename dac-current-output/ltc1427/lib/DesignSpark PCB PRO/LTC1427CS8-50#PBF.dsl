SamacSys ECAD Model
1062813/454976/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LTC1427CS8-50_PBF" (originalName "LTC1427CS8-50_PBF")
		...
		(pin (pinNum 8) (pt 1200 mils -300 mils) (rotation 180) (pinLength 200 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 970 mils -325 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
	...
	(compDef "LTC1427CS8-50#PBF" (originalName "LTC1427CS8-50#PBF") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "__SHDN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "AD1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "IOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTC1427CS8-50_PBF"))
		...
		(attr "Mouser Part Number" "584-LTC1427CS8-50PBF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/LTC1427CS8-50PBF?qs=hVkxg5c3xu82jOB7HsPGTw%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "LTC1427CS8-50#PBF")
		(attr "Description" "LINEAR TECHNOLOGY - LTC1427CS8-50#PBF - DAC, CURRENT OUTPUT, 10BIT, NSOIC-10")
		(attr "Datasheet Link" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-17/DSA-322129.pdf")
